...
Author: Ranbir Dixit
Date: 17/03/2016
Description: Calculates UK Net Salaries after deducting PAYE, Pension and Class 1 NIC for 2016/17 Tax Year
'''
...
def netSalary():
    ...
    if taxableTotal < taxBracketBasicRateLower:
        return grossAnnualSalary-nationalInsurance(grossAnnualSalary)
    elif taxableTotal>=taxBracketBasicRateLower and taxableTotal<taxBracketHigherRateLower:
        totalIncomeTax=taxableTotal*taxBracketBasic
        return taxableSalary-totalIncomeTax-nationalInsurance(grossAnnualSalary)
